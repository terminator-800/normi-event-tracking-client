                  ...
                  <div className="overflow-x-auto">
                    {showingStudents ? (
                      <table className="w-full min-w-[720px] border-collapse text-sm">
                        <thead className="border-b border-[#07713c]/30 bg-[#07713c] text-center text-xs uppercase tracking-wide text-white">
                          <tr>
                            ...
                            <th className="px-3 py-3 text-center">Fine</th>
                          </tr>
                        </thead>
                        <tbody>
                            ...
                            (pagedRows as StudentRow[]).map((s) => {
                              ...
                              return (
                                <tr key={s.id} className="border-b border-[#07713c]/10 hover:bg-[#07713c]/[0.04]">
                                  <td className="px-3 py-2.5 text-center tabular-nums text-black/80">{s.id}</td>
                                  <td className="px-3 py-2.5 text-center font-medium text-black">{s.name}</td>
                                  <td className="px-3 py-2.5 text-center text-black/80">{s.department || "—"}</td>
                                  ...
                                  <td className="px-3 py-2.5 text-center tabular-nums text-black">
                      ...
                      <table className="w-full min-w-[720px] border-collapse text-sm">
                        <thead className="border-b border-[#07713c]/30 bg-[#07713c] text-center text-xs uppercase tracking-wide text-white">
                          <tr>
                            <th className="px-3 py-3 text-center">Event</th>
                          ...
                          {(pagedRows as EventSummary[]).length === 0 ? (
                            ...
                            (pagedRows as EventSummary[]).map((ev) => (
                              <tr key={ev.id} className="border-b border-[#07713c]/10 hover:bg-[#07713c]/[0.04]">
                                <td className="px-3 py-2.5 text-center font-medium text-black">{ev.name}</td>
                                <td className="px-3 py-2.5 text-center text-black/80">
                                  {formatEventDateForDisplay(ev.date)}
                                </td>
                                <td className="px-3 py-2.5 text-center capitalize text-black/80">
                                  {ev.status}
                                </td>
                                <td className="px-3 py-2.5 text-center tabular-nums text-[#07713c]">
                                  {ev.attended}
                                </td>
                                <td className="px-3 py-2.5 text-center tabular-nums text-black">
                                  {ev.absent}
