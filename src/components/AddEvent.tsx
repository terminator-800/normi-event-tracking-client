...
type DurationOption = "whole" | "half";

export default function AddEvent({ onBack, onNext }: AddEventProps) {
  ...
  const [duration, setDuration] = useState<DurationOption>("whole");
  ...
  const validateEventPassword = (): boolean => {
    const e: Record<string, string> = {};
  ...
  const handleNext = () => {
    ...
    if (step === 3) {
      ...
      const backendPayload: AddEventPayload = {
        name: payload.name,
        date: payload.date,
      ...
      addEvent.mutate(backendPayload, {
        ...
        onError: (err) => {
          console.error("[AddEvent] mutate error:", getApiErrorMessage(err), {
  ...
  const preventNumberScrollChange = (e: WheelEvent<HTMLInputElement>) => {
                        ...
                        <div className="min-w-0">
                          ...
                          <select
                            ...
                            onChange={(e) => {
                              ...
                              setErrors((prev) => ({ ...prev, amGraceInMinutes: "" }));
                            }}
                        ...
                        <div className="min-w-0">
                          ...
                          <select
                            ...
                            onChange={(e) => {
                              ...
                              setErrors((prev) => ({ ...prev, pmGraceInMinutes: "" }));
                            }}
          ...
          <div className="relative">
            <input
              ...
              onChange={(e) => {
                ...
                setErrors((prev) => ({ ...prev, eventPassword: "", confirmEventPassword: "" }));
              }}
          ...
          <div className="relative">
            <input
              ...
              onChange={(e) => {
                ...
                setErrors((prev) => ({ ...prev, confirmEventPassword: "" }));
              }}
              className={`w-full rounded-lg border bg-white px-3 py-2 pr-14 text-sm text-black focus:border-[#07713c] focus:outline-none focus:ring-1 focus:ring-[#07713c]/30 ${
