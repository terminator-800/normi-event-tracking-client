...
export default function UserDashboard({ onLogout, onNavigate }) {
  ...
  const [viewCollegeKey, setViewCollegeKey] = useState(null);
  const [modalSelectedCourseKey, setModalSelectedCourseKey] = useState(null);
  ...
  const resetFlow = () => {
    ...
    setSelectedCourseKey(null);
    setDetails({ fullName: "", studentId: "", yearLevel: "", section: "" });
  };
