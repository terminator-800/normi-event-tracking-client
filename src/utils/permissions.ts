...
export const NAV_PERMISSION_BY_ID: Partial<Record<AppNavId, string | string[]>> = {
  ...
  reports_collection_all: ["nav.reports.collection.all", "nav.reports.collection"],
  reports_collection: ["nav.reports.collection.paid", "nav.reports.collection"],
  reports_collection_partial: ["nav.reports.collection.partial", "nav.reports.collection"],
  reports_collection_unpaid: ["nav.reports.collection.unpaid", "nav.reports.collection"],
  ...
  backup: "nav.settings.backup",
  update_student_rfid: ["nav.settings.update_rfid", "action.students.update_rfid"],
  update_password: "nav.settings.update_password",
...
export const ROUTE_PERMISSIONS: Record<string, string | string[]> = {
  ...
  "/reports/collection": ["nav.reports.collection.paid", "nav.reports.collection"],
  "/reports/collection/all": ["nav.reports.collection.all", "nav.reports.collection"],
  "/reports/collection/unpaid": ["nav.reports.collection.unpaid", "nav.reports.collection"],
  "/reports/collection/partial": ["nav.reports.collection.partial", "nav.reports.collection"],
  "/students": "nav.reports.students",
  "/import": "nav.import",
  ...
  "/backup": ["nav.settings.backup", "action.backup.download"],
  "/update-student-rfid": ["nav.settings.update_rfid", "action.students.update_rfid"],
  "/update-password": "nav.settings.update_password",
};
