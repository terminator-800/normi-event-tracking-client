...
import UpdateStudentRfidPage from "./components/UpdateStudentRfidPage";
      ...
      {!isLoggedIn ? (
        ...
        <>
          ...
          <Route
            ...
            element={
              <RequirePermission
                permission={["nav.reports.collection.paid", "nav.reports.collection"]}
                fallbackRoleOk
              >
                <ReportsCollectionPage {...deskProps} mode="paid" />
              </RequirePermission>
            }
          />
          <Route
            path={APP_ROUTES.reportsCollectionAll}
            element={
              <RequirePermission
                permission={["nav.reports.collection.all", "nav.reports.collection"]}
                fallbackRoleOk
              >
                <ReportsCollectionPage {...deskProps} mode="all" />
              </RequirePermission>
            }
          />
          <Route
            path={APP_ROUTES.reportsCollectionUnpaid}
            element={
              <RequirePermission
                permission={["nav.reports.collection.unpaid", "nav.reports.collection"]}
                fallbackRoleOk
              >
                <ReportsCollectionPage {...deskProps} mode="unpaid" />
              </RequirePermission>
            }
          />
          <Route
            path={APP_ROUTES.reportsCollectionPartial}
            element={
              <RequirePermission
                permission={["nav.reports.collection.partial", "nav.reports.collection"]}
                fallbackRoleOk
              >
                <ReportsCollectionPage {...deskProps} mode="partial" />
              </RequirePermission>
            }
          />
          ...
          />
          <Route
            path={APP_ROUTES.backup}
            element={
              <RequirePermission
                permission={["nav.settings.backup", "action.backup.download"]}
                fallbackRoleOk={isSuperAdminUser || isAdminUser || isCsgUser}
              >
                <BackupPage {...deskProps} />
              </RequirePermission>
            }
          />
          <Route
            path={APP_ROUTES.updateStudentRfid}
            element={
              <RequirePermission
                permission={["nav.settings.update_rfid", "action.students.update_rfid"]}
                fallbackRoleOk={isSuperAdminUser || isAdminUser || isCsgUser}
              >
                <UpdateStudentRfidPage {...deskProps} />
              </RequirePermission>
            }
          />
          <Route
            ...
            element={
              <RequirePermission permission="nav.settings.update_password" fallbackRoleOk>
                <UpdatePasswordPage {...deskProps} />
              </RequirePermission>
            }
          />
