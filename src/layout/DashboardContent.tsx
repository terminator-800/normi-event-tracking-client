...
export default function DashboardContent({ onLogout, onNavigate }: DeskPageProps) {
  ...
  return (
    ...
    >
      ...
      {isSuperAdmin && superAdminStats && (
        <>
          <SectionHeading title="System Overview" subtitle="Combined statistics across all accounts" />
          <div className="mb-6 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
            <StatCard label="Total Users" value={Number(superAdminStats.users.total_users)} sub="All accounts" color="text-[#07713C]" />
            <StatCard label="Total Admins" value={Number(superAdminStats.users.total_admins)} sub="Admin accounts" color="text-blue-600" />
            <StatCard label="Total Students" value={Number(superAdminStats.students.total_students)} sub="Enrolled" color="text-indigo-600" />
            <StatCard label="Total Events" value={Number(superAdminStats.events.total_events)} sub="All periods" color="text-orange-600" />
            <StatCard label="Payments Collected" value={Number(superAdminStats.payments.total_payments)} sub="Paid transactions" color="text-green-700" />
          </div>
      ...
      <section className="mb-6">
        <SectionHeading title="Upcoming Events" subtitle={isSuperAdmin ? "All upcoming events across the system" : undefined} />
      ...
      <section className="mb-6">
        <SectionHeading title="Event Statistics" subtitle={isSuperAdmin ? "Loaded from all accounts" : "Current period"} />
